<template>
  <div class="w-full">
    <h1 ref="typingText" class="text-3xl animate-fadeIn py-2 my-2">Login to your account</h1>
    <div
      ref="loginForm"
    ...
    >
      ...
      <div class="flex justify-center items-center">
        <form @submit.prevent="handleLogin" class="flex flex-col w-full">
          ...
          <label for="registerOrReset" class="text-sm w-full flex justify-between items-center mb-2 text-yellow-500">
